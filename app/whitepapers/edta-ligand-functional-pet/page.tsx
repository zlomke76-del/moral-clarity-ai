    ...
    <main className="mx-auto max-w-6xl px-6 py-24 space-y-16">
      ...
      <section className="rounded-[32px] border border-white/10 bg-black p-12">
        <div className="space-y-6">
          ...
          <p className="max-w-2xl text-lg text-white/70 leading-8">
            Evaluation of whether heavy-metal binding can remain structurally
            retained and repeatable across multiple capture–release cycles
            without reliance on leaching or consumable chemistry.
          </p>
        </div>
      </section>
      ...
      <section className="rounded-[36px] border border-white/10 bg-black p-14 text-center">
        ...
        <p className="text-3xl text-white max-w-3xl mx-auto leading-[1.5]">
          Remediation is admissible only if binding capacity persists across
          repeated cycles as a function of retained structure.
        </p>

        <p className="mt-6 text-white/50">
          If capacity degrades with use or depends on extractable species,
      ...
      <section className="max-w-3xl space-y-6">
        ...
        <p className="text-white/70 leading-8">
          Heavy-metal remediation systems often rely on consumable or
          soluble chelating agents, leading to depletion and environmental release.
        </p>
      ...
      <section className="max-w-3xl space-y-6">
        ...
        <p className="text-white/70 leading-8">
          EDTA-like ligand structures are incorporated into PET during
          polymerization to create fixed chelation sites within the material.
        </p>
      </section>
      ...
      <section className="rounded-xl border border-white/10 bg-white/[0.05] p-8 max-w-3xl">
        ...
        <p className="mt-3 text-white/80 leading-8">
          The system fails if binding capacity decreases measurably across
          repeated capture–release cycles or if ligand functionality is lost.
        </p>
      </section>
      ...
      <section className="max-w-3xl space-y-6">
        ...
        <p className="text-white/70 leading-8">
          Repeated binding and release cycles with quantitative measurement
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-white/70 max-w-2xl mx-auto">
          Admissibility is conditional on repeatable binding without degradation.
          Remediation claims are invalid if capacity declines with use.
        </p>
      </section>
      ...
      <section className="rounded-[36px] border border-white/10 bg-black p-16 text-center">
        <p className="text-3xl text-white leading-[1.5]">
          If function does not persist through use,
          <br />
          it is not owned by the material.
        </p>
