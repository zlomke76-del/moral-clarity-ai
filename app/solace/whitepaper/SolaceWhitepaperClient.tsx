...
// Solace Authority System – Fully Upgraded Interactive Whitepaper Page
...
function InvariantChip({
  ...
  return (
    <div className="group relative z-30 isolate overflow-visible rounded-full border border-cyan-300/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] px-4 py-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_12px_34px_rgba(0,0,0,0.18),0_0_0_1px_rgba(34,211,238,0.04)] backdrop-blur-md transition duration-300 hover:z-[140] hover:-translate-y-[2px] hover:border-cyan-300/40 hover:bg-[linear-gradient(180deg,rgba(14,68,94,0.32),rgba(9,31,49,0.22))] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_18px_46px_rgba(0,0,0,0.24),0_0_36px_rgba(34,211,238,0.10)]">
      ...
      <div className="pointer-events-none absolute left-1/2 top-full z-[180] mt-3 hidden w-80 -translate-x-1/2 rounded-[1.25rem] border border-cyan-300/18 bg-[linear-gradient(180deg,rgba(8,22,38,0.98),rgba(5,14,24,0.98))] p-4 text-xs leading-5 text-slate-200 shadow-[0_30px_90px_rgba(0,0,0,0.48),0_0_40px_rgba(34,211,238,0.08)] backdrop-blur-xl group-hover:block">
        ...
        <div className="mb-1 text-[10px] font-semibold uppercase tracking-[0.22em] text-cyan-200/85">Authority Note</div>
        {detail}
      </div>
    </div>
  );
...
function AssertionCard({
  ...
  return (
    <div className="solace-panel group relative overflow-hidden rounded-[1.8rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.035),rgba(255,255,255,0.02))] p-5 shadow-[0_18px_55px_rgba(0,0,0,0.18),inset_0_1px_0_rgba(255,255,255,0.04)] transition duration-300 hover:-translate-y-[2px] hover:border-cyan-400/20 hover:shadow-[0_24px_70px_rgba(0,0,0,0.24),0_0_32px_rgba(34,211,238,0.06)]">
...
function SystemMap() {
  return (
    <div className="solace-panel relative overflow-hidden rounded-[1.9rem] border border-cyan-400/15 bg-[linear-gradient(180deg,rgba(7,26,44,0.96),rgba(5,15,28,0.98))] p-5 shadow-[0_26px_90px_rgba(0,0,0,0.38),0_0_42px_rgba(34,211,238,0.06)]">
      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_0.2fr_1.1fr_0.2fr_0.9fr] lg:items-center">
        ...
        <div className="space-y-4">
          <div className="rounded-[1.65rem] border border-cyan-400/20 bg-[linear-gradient(180deg,rgba(34,211,238,0.1),rgba(34,211,238,0.04))] p-5 shadow-[0_0_30px_rgba(34,211,238,0.08)]">
            ...
            <div className="mt-4 rounded-2xl border border-cyan-300/14 bg-[#071320]/90 px-4 py-3 font-mono text-[11px] uppercase tracking-[0.18em] text-cyan-100/90">
...
function DecisionDemoCard() {
  return (
    <div className="solace-panel relative overflow-hidden rounded-[2rem] border border-cyan-400/15 bg-[linear-gradient(180deg,rgba(8,21,36,0.98),rgba(5,14,24,0.98))] p-6 shadow-[0_26px_90px_rgba(0,0,0,0.34),0_0_40px_rgba(34,211,238,0.05)]">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-cyan-300/45 to-transparent" />
      <div className="grid gap-6 xl:grid-cols-[1.02fr_0.98fr]">
        <div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2 rounded-2xl border border-cyan-300/14 bg-[#071320]/90 px-4 py-3 font-mono text-[11px] uppercase tracking-[0.18em] text-cyan-100/90">Evaluating · state snapshot current · scope token active · integrity verified</div>
...
function BoundaryParticleField() {
  const particles = [
    { left: "5%", delay: "0s", duration: "4.8s", verdict: "pass", size: "10px" },
    { left: "11%", delay: "1.1s", duration: "5.2s", verdict: "reject", size: "8px" },
    { left: "17%", delay: "2.4s", duration: "4.6s", verdict: "reject", size: "9px" },
    { left: "24%", delay: "0.6s", duration: "5.5s", verdict: "pass", size: "12px" },
    { left: "31%", delay: "2.9s", duration: "4.9s", verdict: "reject", size: "7px" },
    { left: "39%", delay: "1.8s", duration: "5.0s", verdict: "reject", size: "10px" },
    { left: "48%", delay: "0.2s", duration: "4.7s", verdict: "pass", size: "11px" },
    { left: "56%", delay: "2.0s", duration: "5.4s", verdict: "reject", size: "8px" },
    { left: "64%", delay: "0.9s", duration: "4.8s", verdict: "reject", size: "9px" },
    { left: "72%", delay: "3.1s", duration: "5.1s", verdict: "pass", size: "12px" },
    { left: "81%", delay: "1.5s", duration: "5.3s", verdict: "reject", size: "8px" },
    { left: "90%", delay: "2.6s", duration: "4.9s", verdict: "reject", size: "10px" },
  ] as const;

  return (
    <div className="pointer-events-none absolute inset-x-6 top-0 bottom-[-34px] z-20 overflow-hidden">
      <div className="absolute inset-x-0 top-0 bottom-14">
        {particles.map((particle, index) => (
          <div
            key={`${particle.left}-${index}`}
            className={`solace-particle ${particle.verdict === "pass" ? "solace-particle-pass" : "solace-particle-reject"}`}
            style={{
              left: particle.left,
          ...
          >
            <span className="solace-particle-core" />
          </div>
        ))}
      </div>

      <div className="absolute inset-x-0 bottom-14 h-[1px] bg-gradient-to-r from-transparent via-cyan-300/50 to-transparent shadow-[0_0_18px_rgba(34,211,238,0.22)]" />
      <div className="absolute inset-x-[2%] bottom-[50px] h-16 rounded-full bg-cyan-300/[0.03] blur-2xl" />

      <div className="absolute left-[8%] bottom-[18px] h-5 w-5 rounded-full border border-rose-300/22 bg-rose-400/[0.08] shadow-[0_0_22px_rgba(244,63,94,0.10)]" />
      <div className="absolute left-[19%] bottom-[26px] h-3 w-3 rounded-full bg-rose-300/18 blur-[1px]" />
      <div className="absolute left-[33%] bottom-[14px] h-4 w-4 rounded-full border border-rose-300/18 bg-rose-400/[0.08]" />
      <div className="absolute left-[58%] bottom-[23px] h-3.5 w-3.5 rounded-full bg-rose-300/18 blur-[1px]" />
      <div className="absolute left-[69%] bottom-[16px] h-5 w-5 rounded-full border border-rose-300/18 bg-rose-400/[0.08]" />
      <div className="absolute left-[87%] bottom-[24px] h-4 w-4 rounded-full bg-rose-300/18 blur-[1px]" />

      <div className="absolute left-[23%] bottom-[-18px] h-8 w-8 rounded-full border border-cyan-300/24 bg-cyan-400/[0.10] shadow-[0_0_28px_rgba(34,211,238,0.16)]" />
      <div className="absolute left-[47%] bottom-[-22px] h-9 w-9 rounded-full border border-cyan-300/24 bg-cyan-400/[0.12] shadow-[0_0_34px_rgba(34,211,238,0.20)]" />
      <div className="absolute left-[74%] bottom-[-20px] h-8 w-8 rounded-full border border-cyan-300/24 bg-cyan-400/[0.10] shadow-[0_0_28px_rgba(34,211,238,0.16)]" />
    </div>
  );
}
...
export default function SolaceWhitepaperPage() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_50%_-10%,rgba(34,211,238,0.08),transparent_28%),radial-gradient(circle_at_85%_8%,rgba(59,130,246,0.08),transparent_24%),linear-gradient(180deg,#040b14_0%,#06101d_32%,#040c15_100%)] text-white">
      <style>{`
        ...
        @keyframes solaceParticleReject {
          0% {
          ...
          72% {
            transform: translateY(calc(100% - 88px)) scale(1);
            opacity: 0.95;
          }
          82% {
            transform: translateY(calc(100% - 72px)) scale(0.8);
            opacity: 0.55;
          }
          100% {
            transform: translateY(calc(100% - 94px)) scale(0.28);
            opacity: 0;
          }
        }

        @keyframes solaceParticlePass {
          0% {
            transform: translateY(-22px) scale(0.78);
            opacity: 0;
          }
          ...
          70% {
            transform: translateY(calc(100% - 86px)) scale(1);
            opacity: 1;
          }
          100% {
            transform: translateY(calc(100% + 18px)) scale(0.52);
            opacity: 0;
          }
        }
        ...
        .solace-particle-reject {
          animation-name: solaceParticleReject;
          animation-timing-function: linear;
          animation-iteration-count: infinite;
          filter: drop-shadow(0 0 12px rgba(251, 113, 133, 0.35));
        }

        .solace-particle-reject .solace-particle-core {
          background: radial-gradient(circle at 35% 35%, rgba(255,255,255,0.9), rgba(251,113,133,0.92) 42%, rgba(244,63,94,0.48) 72%, rgba(244,63,94,0.0) 100%);
          box-shadow: 0 0 14px rgba(244,63,94,0.24);
        }

        .solace-particle-pass {
          animation-name: solaceParticlePass;
          animation-timing-function: linear;
          animation-iteration-count: infinite;
          filter: drop-shadow(0 0 18px rgba(34, 211, 238, 0.42));
        }

        .solace-particle-pass .solace-particle-core {
          background: radial-gradient(circle at 35% 35%, rgba(255,255,255,0.98), rgba(103,232,249,0.95) 40%, rgba(34,211,238,0.62) 72%, rgba(34,211,238,0.0) 100%);
        ...
        .solace-panel::before {
          ...
          background:
            ...
            radial-gradient(circle at bottom right, rgba(59, 130, 246, 0.07), transparent 30%);
          pointer-events: none;
          z-index: -1;
        }
        ...
        .solace-orb {
          animation: solacePulse 10s ease-in-out infinite;
          filter: blur(40px);
        }

        .solace-stars {
          background-image:
            radial-gradient(circle at 20% 30%, rgba(186,230,253,0.16) 0 1px, transparent 1.5px),
            radial-gradient(circle at 70% 18%, rgba(103,232,249,0.18) 0 1px, transparent 1.5px),
            radial-gradient(circle at 80% 72%, rgba(125,211,252,0.16) 0 1px, transparent 1.5px),
            radial-gradient(circle at 34% 76%, rgba(103,232,249,0.14) 0 1px, transparent 1.5px);
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_34%_12%,rgba(34,211,238,0.22),transparent_22%),radial-gradient(circle_at_72%_20%,rgba(59,130,246,0.18),transparent_24%),radial-gradient(circle_at_50%_0%,rgba(14,165,233,0.12),transparent_34%),linear-gradient(180deg,#071221_0%,#06101d_100%)]">
        ...
        <div className="solace-stars absolute inset-0" />
        <div className="solace-orb absolute left-[12%] top-[10%] h-40 w-40 rounded-full bg-cyan-300/10" />
        <div className="solace-orb absolute right-[18%] top-[16%] h-52 w-52 rounded-full bg-sky-400/10" />
        <div className="solace-orb absolute left-[46%] bottom-[12%] h-48 w-48 rounded-full bg-cyan-400/8" />
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="max-w-6xl">
            ...
            <div className="relative z-[120] mt-8 flex flex-wrap gap-3">
              <InvariantChip
                index={0}
            ...
            <div className="mt-12 grid gap-5 lg:grid-cols-[1.08fr_0.92fr]">
              <div className="solace-panel solace-scanline solace-glass-edge relative overflow-hidden rounded-[2rem] border border-cyan-400/20 bg-[linear-gradient(180deg,rgba(6,50,77,0.28),rgba(6,27,42,0.2))] p-7 backdrop-blur-[12px]">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-cyan-300/45 to-transparent" />
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 py-14 lg:grid-cols-[290px_minmax(0,1fr)] lg:px-8 lg:py-18">
        <aside className="lg:sticky lg:top-24 lg:self-start">
          <div className="solace-panel relative overflow-hidden rounded-[1.9rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02))] p-5 shadow-[0_18px_55px_rgba(0,0,0,0.24),inset_0_1px_0_rgba(255,255,255,0.04)]">
            <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-cyan-300/20 to-transparent" />
