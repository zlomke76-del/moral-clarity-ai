...
const sections = [
  ...
  { id: "authority-access", label: "Authority Access" },
];
      ...
      <div className="grid gap-6 xl:grid-cols-[1.02fr_0.98fr]">
        ...
        <div className="rounded-[1.7rem] border border-cyan-400/20 bg-[linear-gradient(180deg,rgba(34,211,238,0.08),rgba(255,255,255,0.02))] p-5 shadow-[0_0_30px_rgba(34,211,238,0.05)]">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <a
              href="#authority-access"
              className="inline-flex items-center justify-center rounded-xl border border-cyan-300/20 bg-cyan-300/90 px-4 py-2.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-950 transition hover:bg-cyan-200"
            >
              Test a Real Scenario
            </a>
            <a
              href="#authority-access"
              className="inline-flex items-center justify-center rounded-xl border border-cyan-300/18 bg-white/[0.03] px-4 py-2.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-100 transition hover:border-cyan-300/35 hover:bg-cyan-400/[0.08]"
            >
              Request Evaluation
            </a>
          </div>
...
function AuthorityEvaluationSection() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch("/api/authority-evaluation", {
        method: "POST",
        headers: {
      ...
      const data = (await response.json()) as { ok?: boolean; message?: string; referenceId?: string };

      if (!response.ok || !data.ok) {
        throw new Error(data.message || "Unable to submit authority evaluation request.");
      }

      setStatus("success");
      setMessage(
        data.referenceId
          ? `Authority evaluation requested · Reference ${data.referenceId}`
          : data.message || "Authority evaluation requested."
      );
      setForm({
        fullName: "",
        workEmail: "",
      ...
      setMessage(
        error instanceof Error
          ? error.message
          : "Unable to submit authority evaluation request."
      );
    }
  }

  return (
    <section id="authority-access" className="scroll-mt-28">
      <SectionHeading
        kicker="Authority Access"
        title="Request a controlled authority evaluation for your environment."
        body="Bring a real decision surface, operating environment, or execution risk. Solace will evaluate where correctness, authority, or proof may fail before consequence begins."
      />

      <div className="solace-panel relative overflow-hidden rounded-[2rem] border border-cyan-400/18 bg-[linear-gradient(180deg,rgba(9,24,39,0.98),rgba(5,13,23,0.98))] p-6 shadow-[0_30px_90px_rgba(0,0,0,0.34),0_0_44px_rgba(34,211,238,0.06)]">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.12),transparent_28%),radial-gradient(circle_at_bottom_right,rgba(59,130,246,0.08),transparent_26%)]" />
        ...
        <div className="relative grid gap-8 xl:grid-cols-[0.92fr_1.08fr]">
          <div className="space-y-5">
            <div className="inline-flex items-center rounded-full border border-cyan-300/18 bg-cyan-400/[0.08] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-cyan-200">
              Controlled next step
            </div>

            <h3 className="text-3xl font-semibold tracking-tight text-white">
              If this system were applied to your environment…
            </h3>

            <p className="max-w-xl text-base leading-7 text-slate-300">
              Which of your current decisions would fail admissibility at execution?
              The goal is not a generic demo. It is a bounded evaluation against real
              authority, state, and proof conditions.
            </p>

            <div className="grid gap-4">
              <div className="rounded-[1.4rem] border border-white/10 bg-white/[0.03] p-4">
                <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-cyan-200/90">
                  What to bring
                </div>
                <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-300">
                  <li>One decision surface with real consequence.</li>
                  <li>The current environment or operating boundary.</li>
                  <li>The point where approval, authority, or proof may break.</li>
                </ul>
              </div>
              ...
              <div className="rounded-[1.4rem] border border-white/10 bg-white/[0.03] p-4">
                ...
                <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-300">
                  <li>A focused authority review against execution risk.</li>
                  <li>Clear identification of state, scope, and proof gaps.</li>
                  <li>A controlled scenario appropriate for your environment.</li>
                </ul>
              </div>

              <div className="rounded-[1.4rem] border border-cyan-300/14 bg-[#071320]/92 px-4 py-3 font-mono text-[11px] uppercase tracking-[0.18em] text-cyan-100/90">
                Intake path · enterprise and high-consequence environments only
              </div>
            </div>
          </div>

          <div className="rounded-[1.7rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02))] p-5 shadow-[0_18px_55px_rgba(0,0,0,0.22),inset_0_1px_0_rgba(255,255,255,0.04)]">
            <div className="mb-4">
              <div className="text-[11px] font-semibold uppercase tracking-[0.24em] text-cyan-300/85">
                Authority Evaluation Form
              </div>
              <div className="mt-2 text-lg font-semibold text-white">
                Minimal intake. Real scenario.
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <label className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-[#08111e]/90 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300/35"
                ...
                <label className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-[#08111e]/90 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300/35"
                    placeholder="CTO, Risk, Compliance, Platform..."
                  />
                </label>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-[1fr_1fr_180px]">
                <label className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-[#08111e]/90 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300/35"
                    placeholder="Healthcare, finance, enterprise ops..."
                  />
                </label>
                ...
                <label className="space-y-2">
                  ...
                  <input
                    required
                    value={form.decisionSurface}
                    onChange={(event) => setForm((current) => ({ ...current, decisionSurface: event.target.value }))}
                    className="w-full rounded-xl border border-white/10 bg-[#08111e]/90 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300/35"
                    placeholder="Payments, triage, approvals, agents..."
                  />
                </label>
                ...
                <label className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-white/10 bg-[#08111e]/90 px-4 py-3 text-sm text-white outline-none transition focus:border-cyan-300/35"
                  >
              ...
              <label className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={(event) => setForm((current) => ({ ...current, scenarioSummary: event.target.value }))}
                  className="w-full rounded-2xl border border-white/10 bg-[#08111e]/90 px-4 py-3 text-sm leading-6 text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300/35"
                  placeholder="Describe the decision, where execution begins, and where you are most concerned that authority, state, or proof may fail."
                />
              </label>

              <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:items-center sm:justify-between">
                <div className="rounded-full border border-cyan-300/12 bg-cyan-400/[0.06] px-3 py-2 text-[11px] uppercase tracking-[0.18em] text-cyan-100/85">
                  Controlled access · no generic intake queue
                </div>

                <button
                  type="submit"
                  disabled={status === "submitting"}
                  className="inline-flex items-center justify-center rounded-xl border border-cyan-300/20 bg-cyan-300/90 px-5 py-3 text-sm font-semibold tracking-[0.14em] text-slate-950 transition hover:-translate-y-[1px] hover:bg-cyan-200 disabled:cursor-not-allowed disabled:opacity-70"
                >
                  {status === "submitting" ? "Submitting..." : "Request Authority Evaluation"}
                </button>
              </div>
          ...
          <div className="max-w-6xl">
            ...
            <div className="mt-10 max-w-5xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  href="#authority-access"
                  className="inline-flex items-center justify-center rounded-xl border border-cyan-300/20 bg-cyan-300/90 px-5 py-3 text-sm font-semibold tracking-[0.14em] text-slate-950 transition hover:-translate-y-[1px] hover:bg-cyan-200"
                >
                  Request Authority Evaluation
                </a>
                <a
                  href="#authority-console"
                  className="inline-flex items-center justify-center rounded-xl border border-cyan-300/18 bg-white/[0.03] px-5 py-3 text-sm font-semibold tracking-[0.14em] text-cyan-100 transition hover:-translate-y-[1px] hover:border-cyan-300/35 hover:bg-cyan-400/[0.08]"
                >
