...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Executable experiments thimport type { Metadata } from "next";
import Link from "next/link";
      ...
      <article className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <ul>
          ...
          <li>
            ...
            <br />
            <span className="text-sm text-muted-foreground">
              Positive-sum experiments that unlock underexploited physical mechanisms
              for energy, water, and environmental systems
            </span>
          </li>
...
at surface hidden assumptions with direct human relevance.",
    url: "https://moralclarity.ai/edge-of-practice",
    siteName: "Moral Clarity AI",
    type: "article",
  },
