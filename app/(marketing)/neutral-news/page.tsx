      ...
      <section className="border-b border-slate-800 bg-slate-950/95 px-6 py-20">
        <div className="mx-auto flex max-w-5xl flex-col items-start gap-6">
          ...
          <p className="max-w-2xl text-lg text-slate-300">
            Solace reads a verified, bias-scored news ledger.
            No browsing. No hallucination.
          </p>
          ...
          <div className="mt-4 flex gap-4">
            ...
            <a
              href="#how-it-works"
              className="rounded-lg border border-slate-700 px-6 py-3 text-sm text-slate-200 hover:bg-slate-900"
            >
              How it Works
            </a>
          </div>
