...
const EDGES: EdgeItem[] = [
  {
    ...
    slug: "/edge/knowledge",
    description:
      "Defines what is admissibly known, unknown, unobservable, or falsely assumed before action can proceed.",
  ...
  },
  {
    ...
    slug: "/edge/practice",
    description:
      "Defines what remains valid when tested against stress, falsification, and real-world operational failure.",
  ...
  },
  {
    ...
    description:
      "Defines where harm, misuse, authority leakage, and drift are prevented through enforceable boundary conditions.",
  ...
  },
  {
    ...
    description:
      "Defines who holds responsibility, how authority is bounded, and where accountability remains attached.",
  ...
  },
  {
    ...
    description:
      "Defines the binary market boundary where systems become economically accountable through provable control.",
