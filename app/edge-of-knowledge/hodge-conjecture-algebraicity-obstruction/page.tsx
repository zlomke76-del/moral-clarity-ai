    ...
    <main className="mx-auto max-w-3xl px-6 py-16">
      <article className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          ...
          <code> H^{2p}(X, ℚ) ∩ H^{p,p}(X, ℂ)</code> is a rational linear
          combination of cohomology classes of algebraic cycles of codimension
          <code>p</code> on <code>X</code>.
        </p>
        ...
        <h2>Scope</h2>
        <p>
          The conjecture applies to all smooth, projective varieties over
          <code> ℂ</code> and concerns the relationship between Hodge-theoretic
          (analytic) and algebraic (cycle-theoretic) origins of cohomology
          classes.
        </p>
        ...
        <p>
          All major approaches implicitly assume that the space of rational
          Hodge <code>(p,p)</code>-classes is exhaustively generated by algebraic
          cycles.
        </p>
        ...
        <ul>
          ...
          <li>
            Normal function and regulator methods detect some obstructions but
            do not characterize all possibilities.
          </li>
          <li>
        ...
        <p>
          In all cases, the relationship between Hodge classes and algebraic
          cycles must be demonstrated through observable, structurally
          verifiable mechanisms—not analogy or deformation heuristics alone.
        </p>
