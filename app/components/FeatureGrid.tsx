...
export default function FeatureGrid() {
  return (
    <section
      aria-labelledby="mca-workspaces-heading"
    ...
    >
      <div>
        ...
        <h2
          id="mca-workspaces-heading"
          className="mt-1 text-xl font-semibold tracking-tight text-slate-50 sm:text-2xl"
        >
          MCAI Neural Workspaces
        </h2>
        <p className="mt-1 max-w-xl text-xs text-slate-400 sm:text-[13px]">
