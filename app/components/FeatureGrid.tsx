      ...
      {workspaceCards.map((ws) => (
        <Link
          ...
          className="
            ...
            border border-slate-700/70 bg-slate-950/80 p-4 text-sm text-slate-100
            shadow-[0_18px_60px_rgba(15,23,42,0.9)]
            transition
            hover:border-cyan-400/80 hover:bg-slate-950
            hover:shadow-[0_24px_80px_rgba(8,47,73,0.95)]
          "
        >
          <div className="absolute inset-0 pointer-events-none opacity-0 transition-opacity duration-300 group-hover:opacity-100 bg-[radial-gradient(circle_at_0%_0%,rgba(56,189,248,0.3),transparent_55%),radial-gradient(circle_at_100%_100%,rgba(168,85,247,0.28),transparent_55%)]" />
