    ...
    >
      ...
      <div className="mb-4 flex items-center gap-3">
        ...
        <div className="flex flex-col leading-tight">
          <span className="text-[0.62rem] font-semibold uppercase tracking-[0.28em] text-slate-400">
            Moral Clarity
          </span>
          <span className="text-[0.9rem] font-medium text-slate-100">
            Studio
          </span>
        </div>
      </div>
      ...
      {/* Label */}
      <div className="text-[0.78rem] font-medium uppercase tracking-[0.22em] text-slate-500">
        Workspace
      </div>
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex min-w-0 flex-col">
          <div className="truncate text-[0.92rem] font-medium text-slate-100">
            {item.label}
          </div>
          {item.description && (
            <div className="truncate text-[0.78rem] text-slate-400">
              {item.description}
            </div>
          )}
        </div>
