  ...
  return (
    <Shell>
      {!hasSrc ? (
        ...
        <div className="rounded-lg border border-red-900 bg-red-
That isn't the entire code
Here’s the complete code for your PDF viewer, ensuring all components are included:
